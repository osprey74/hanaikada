...
pub fn run() {
    ...
    tauri::Builder::default()
        ...
        .register_asynchronous_uri_scheme_protocol(media::FULL_SCHEME, media::handle_full_request)
        .setup(|app| {
            ...
            // メディアのディスクキャッシュ（thumb / full スキームが参照）。
            let media_cache = media::MediaCache::new(data_dir.clone())?;
